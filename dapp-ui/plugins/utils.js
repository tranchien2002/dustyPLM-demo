...
let account = null;
let airbnbContract;
let airbnbContractAddress = '0x10973fB964757E1332F99849C0b0C060677937DB'; // Paste Contract address here
...
function getAirbnbContract() {
  ...
  console.log();
  airbnbContract =
    airbnbContract || new metamaskWeb3.eth.Contract(AirbnbABI.abi, airbnbContractAddress);
...
export async function fetchAllProperties() {
  ...
  const airBnb = await getAirbnbContract();
  console.log('id', airBnb.methods);

  // const propertyId = await getAirbnbContract()
  //   .methods.propertyId()
  //   .call();
  const propertyId = await airBnb.methods.propertyId().call();
